...
const features = [
  {
    icon: Clock,
    title: "Daily Code Security",
    description:
      "New QR code and CPS code every day at midnight. Prevents sharing and fraud.",
  },
  {
    icon: QrCode,
    title: "Quick QR Verification",
    description:
      "Show your QR code or CPS code. Get verified and served in seconds.",
  },
  {
    icon: Smartphone,
  ...
  },
  {
    ...
    description:
      "Locations prepare exact quantities, reducing food waste by up to 40%.",
  },
  {
    icon: Shield,
    title: "Secure M-Pesa Payments",
    description:
      "Pay safely via M-Pesa, Airtel Money, or TigoPesa. Your money is protected.",
  },
];
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2">
          ...
          <div>
            ...
            <p className="mt-4 text-lg text-muted-foreground">
              Built for all Tanzanians - students, office workers, market traders and more. 
              Modern features that make dining effortless.
            </p>
