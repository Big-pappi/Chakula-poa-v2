...
const steps = [
  {
    icon: UserPlus,
    title: "1. Register",
    description: "Sign up with your phone number and select your location. Get your unique CPS number instantly.",
    color: "bg-primary/10 text-primary",
  },
  {
    icon: CreditCard,
    title: "2. Subscribe",
    description: "Choose a meal plan that fits your needs. Pay securely via M-Pesa, Airtel Money, or TigoPesa.",
    color: "bg-accent/10 text-accent-foreground",
  },
  {
    icon: Utensils,
    title: "3. Get Daily Code",
    description: "Receive a new QR code and CPS code every day at midnight. Valid for tea, lunch, and evening meals.",
    color: "bg-primary/10 text-primary",
  },
  {
    icon: CheckCircle2,
    title: "4. Collect",
    description: "Show your daily CPS code or QR code at your location. Get your meal quickly without waiting in line.",
    color: "bg-accent/10 text-accent-foreground",
  },
];
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-lg text-muted-foreground">
            Get started in minutes. Four simple steps to hassle-free meals across Tanzania.
          </p>
        </div>
