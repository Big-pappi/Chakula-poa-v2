...
class Restaurant(models.Model):
    ...
    # Payout account information for receiving payments
    payout_method = models.CharField(
        max_length=20,
        choices=PAYOUT_METHOD_CHOICES,
        blank=True,
        null=True,
        help_text="Method for receiving payouts"
    )
    payout_account_number = models.CharField(
        max_length=50,
        blank=True,
        null=True,
        help_text="Phone number or bank account number for payouts"
    )
    payout_account_name = models.CharField(
        max_length=100,
        blank=True,
        null=True,
        help_text="Name on the payout account"
    )
    payout_bank_name = models.CharField(
        max_length=100,
        blank=True,
        null=True,
        help_text="Bank name if using bank transfer"
    )
